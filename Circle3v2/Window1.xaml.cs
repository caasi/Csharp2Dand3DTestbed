...
using System.ComponentModel;  // added to enable use of dependency properties
...
namespace GraphicsBook
{
    ...
    public partial class Window1 : Window
    {
        ...
        /// <summary>
        /// When any Dot changes (in particular, when it's released during a click-and-drag, so that the Position property
        /// changes), dotDescr, a DependencyPropertyDescriptor
        /// causes this proc to be called, which updates the circle that's supposed to pass through the Dots. 
        /// </summary> 
